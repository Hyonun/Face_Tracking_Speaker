...
faceCascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') #set frontal face
profaceCascade = cv2.CascadeClassifier('haarcascade_profileface.xml') # set profile face
...
while True:
    ...
    if k == 27: # press 'ESC' to quit
        pi.set_servo_pulsewidth(23, 1500) #reset servo position
